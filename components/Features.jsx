...
const Features = () => {
  return (
    <div className="h-auto md:mx-32 md:p-20 px-4 py-4" >
      <div className="grid gap-12 grid-cols-1 place-items-center place-content-center md:grid-cols-2">
        {" "}
        <div className="flex flex-col items-center">
          ...
          <p className="leading-loose font-light w-auto text-center">
        ...
        <div className="flex flex-col">
          ...
          <p className="leading-loose font-light text-center md:text-start text-cente w-auto">
